...
//          #10; num1 = -100; num2 = -50; operation = 5;
          ...
          num1 = 8'b01101011; num2 = 0; operation = 4'b0111; opselect = 2'b00; shift_amt = 2;
          #10; num1 = 8'b01101011; operation = 4'b0111; opselect = 2'b01; shift_amt = 2;
          #10; num1 = 8'b01101011; operation = 4'b0111; opselect = 2'b10; shift_amt = 2;
          #10; num1 = 8'b01101011; operation = 4'b0111; opselect = 2'b11; shift_amt = 2;
                                                                   
          #10; num1 = 8'b11101011; operation = 4'b0111; opselect = 2'b00; shift_amt = 2;
          #10; num1 = 8'b11101011; operation = 4'b0111; opselect = 2'b01; shift_amt = 2;
          #10; num1 = 8'b11101011; operation = 4'b0111; opselect = 2'b10; shift_amt = 2;
          #10; num1 = 8'b11101011; operation = 4'b0111; opselect = 2'b11; shift_amt = 2;
          
          #10; num1 = 15; num2 = 12; operation = 4'b1000; opselect = 2'b00; shift_amt = 0;
          #10; num1 = 15; num2 = -12;
          #10; num1 = -15; num2 = 12;
          #10; num1 = -15; num2 = -12;
