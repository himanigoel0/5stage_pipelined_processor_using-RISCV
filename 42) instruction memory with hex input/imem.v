...
module imem(
    ...
    initial begin
        ...
        imem[5] = 16'h0528;     // slt
        imem[6] = 16'h0628;     // nor
        imem[7] = 16'h0728;     // shift left logical
        imem[8] = 16'h0729;     // shift left arithmetic
        imem[9] = 16'h072A;     // shift right logical
        imem[10] = 16'h072B;    // shift right arithmetic
        imem[11] = 16'h0828;    // multiplication
